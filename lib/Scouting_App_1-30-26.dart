...
class ScoutData {
  ...
  static List<excel.CellValue> getHeaders() {
    return [
      ...
      excel.TextCellValue('A Fuel Missed'),
      excel.TextCellValue('Climb'),
      excel.TextCellValue('Fed'),
      excel.TextCellValue('Pick up location?'),
      excel.TextCellValue('T Fuel Scored'),
      excel.TextCellValue('T Fuel Missed'),
      excel.TextCellValue('Robot Fed'),
      ...
      body: Container(
        decoration: BoxDecoration(
          gradient: LinearGradient(
            ...
            colors: [Color.fromARGB(255, 247, 239, 180), Colors.white],
          ),
        ),
        child: SafeArea(
          child: Column(
                  ...
                  child: Column(
                    children: [
                      ...
                      _buildAdvancedCounter(
                        ...
                        setState(() => widget.data.autoFuelMissed = val);
                      }, Colors.red),
                      const SizedBox(height: 20),
                      ...
                      const SizedBox(height: 20),
                      _buildToggle('Fed', widget.data.fed, (val) {
                        setState(() => widget.data.fed = val);
                      }, Icons.fastfood),
                      const SizedBox(height: 20),
        ...
        child: Column(
          children: [
            ...
            Row(
              mainAxisAlignment: MainAxisAlignment.center,
              children: [
                _advancedCounterButton(
                    '+1', () => onChanged(value + 1), Colors.green.shade700),
                const SizedBox(width: 12),
                _advancedCounterButton(
                    '+5', () => onChanged(value + 5), Colors.green.shade600),
                const SizedBox(width: 12),
                _advancedCounterButton(
                    '+10', () => onChanged(value + 10), Colors.green.shade500),
              ],
            ),
                ...
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    children: [
                      ...
                      const SizedBox(height: 20),
                      _buildAdvancedCounter(
                          'T Fuel Missed', widget.data.teleopFuelMissed, (val) {
                        ...
                        children: [
                          Expanded(
                            child: _buildActionButton(
                              'Robot Fed',
                              Icons.restaurant,
                              widget.data.robotFed,
                              Colors.blue,
                              () {
                                setState(() => widget.data.robotFed++);
                              },
                            ),
                          ),
                          const SizedBox(width: 16),
